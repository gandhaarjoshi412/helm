...
export function ShipSection() {
  ...
  const storySteps = [
    ...
    },
    {
      ...
      headline: "Developer Opens HELM Mobile",
      desc: "From their phone, the developer asks HELM what changed in natural language.",
      dialogue: {
        speaker: "Developer",
    ...
    },
    {
      id: 2,
      time: "10:43 PM",
      actor: "HELM Intelligence",
      headline: "Autonomous Diagnosis in 8 Seconds",
      desc: "HELM pinpoints the exact regression in the payment client.",
      dialogue: {
        speaker: "HELM",
    ...
    },
    {
      ...
      desc: "The developer taps Approve. HELM commits, pushes branch, executes CI pipeline, and monitors canary health.",
      dialogue: {
        speaker: "HELM",
  ...
  return (
    <section id="ship" className="relative py-28 bg-[#07080a] border-t border-white/[0.06] overflow-hidden">
      {/* Background Radial Glow */}
      <div className="absolute left-1/2 bottom-0 -translate-x-1/2 w-[700px] h-[350px] bg-emerald-500/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-[#0c0e14] border border-white/[0.1] p-6 sm:p-10 shadow-[0_25px_70px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.08)] relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {storySteps[currentStep].dialogue && (
                <div className="p-4 rounded-2xl bg-zinc-950/80 border border-white/[0.08] space-y-2">
                  <div className="text-[11px] font-mono font-bold uppercase tracking-wider text-sky-400">
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-gradient-to-b from-[#12161f] to-[#090b0f] border border-white/[0.12] flex flex-col justify-between min-h-[320px] text-center">
