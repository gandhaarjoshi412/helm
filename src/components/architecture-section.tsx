...
export function ArchitectureSection() {
  ...
  return (
    <section id="architecture" className="relative py-24 bg-[#08090b] border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed font-mono">
            HELM decouples client command surfaces from backend execution sandboxes and model providers. Your project state remains unified, sovereign, and secure.
          </p>
        </div>

        {/* Visual Architecture Diagram */}
        <div className="rounded-3xl bg-[#0b0d12] border border-white/[0.08] p-6 sm:p-10 shadow-2xl mb-12 relative overflow-hidden font-mono">
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Connecting line */}
            <div className="w-0.5 h-8 bg-gradient-to-b from-sky-400 to-sky-500 my-1" />

            {/* Layer 2: HELM CONTROL PLANE */}
            <div className="w-full max-w-2xl p-4 rounded-2xl bg-gradient-to-r from-sky-950/40 via-zinc-900 to-sky-950/40 border border-sky-500/40 text-center shadow-[0_0_30px_rgba(56,189,248,0.1)]">
              <div className="flex items-center justify-center gap-2 text-white font-bold text-sm">
                <HelmMark size={20} glow />
                <span>HELM UNIFIED CONTROL PLANE & EVENT BUS</span>
              </div>
            ...
            <div className="w-full max-w-xl grid grid-cols-3 gap-4 my-2">
              ...
              <div className="flex justify-center"><div className="w-0.5 h-6 bg-sky-400" /></div>
              <div className="flex justify-center"><div className="w-0.5 h-6 bg-white/20" /></div>
            </div>
            ...
            <div className="w-full max-w-3xl grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-3.5 rounded-xl bg-zinc-950 border border-white/[0.08] text-center space-y-1">
                <Cpu className="w-4 h-4 text-sky-400 mx-auto" />
                <div className="font-bold text-xs text-white">Project Brain</div>
                <div className="text-[10.5px] text-zinc-400">AST Graph & Memory</div>
              </div>

              <div className="p-3.5 rounded-xl bg-zinc-950 border border-sky-500/30 text-center space-y-1 shadow-[0_0_20px_rgba(56,189,248,0.1)]">
            ...
            {/* Connecting line */}
            <div className="w-0.5 h-8 bg-sky-400 my-1" />
