...
export function ModelSection() {
  ...
  return (
    <section className="relative py-20 bg-black border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-4 mb-14">
          ...
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed font-mono">
            <strong className="text-white">Kodium is the control layer, not the model.</strong> Our architecture is engineered so you can swap, route, or self-host models according to latency, cost, and strict enterprise privacy policies.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isSelected
                    ? "bg-zinc-900 border-white/60 shadow-[0_0_25px_rgba(255,255,255,0.18)] text-white"
                ...
                <div>
                  ...
                  <div className="space-y-1.5 pt-3 border-t border-white/[0.06] text-[11px]">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-zinc-200 truncate max-w-[170px]">{m.strength}</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-6 p-3.5 rounded-xl bg-zinc-950/80 border border-white/[0.06] flex items-center gap-2.5 text-xs font-mono text-zinc-400">
          ...
          <span>
            Kodium includes unified adapter interfaces designed to support any OpenAI-compatible API, custom inference endpoint, or local vLLM server with zero telemetry leaks.
          </span>
        </div>
      </div>
    </section>
