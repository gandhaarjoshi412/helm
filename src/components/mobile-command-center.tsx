...
export function MobileCommandCenter() {
  ...
  return (
    <section id="mobile" className="relative py-24 bg-[#090b0e] border-t border-white/[0.06] overflow-hidden">
      {/* Background Ambient Glow */}
      <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                {screens.map((sc, idx) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeScreen === idx
                        ? "bg-zinc-900 border-sky-400/60 shadow-[0_0_16px_rgba(56,189,248,0.12)] text-white"
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isVoiceListening
                      ...
                      : "bg-zinc-900 border-white/10 text-sky-400 hover:bg-zinc-800"
                  )}
          ...
          <div className="lg:col-span-5 flex justify-center">
            <PhoneFrame statusText="HELM OS" time="10:42">
                ...
                <div className="p-4 flex flex-col justify-between h-full font-mono text-xs">
                  <div className="space-y-3">
                    ...
                    <div className="p-3 rounded-xl bg-zinc-900/80 border border-white/[0.08] space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-sky-400 text-[10.5px] uppercase font-bold flex items-center gap-1">
              ...
              {activeScreen === 1 && (
                <div className="p-4 flex flex-col justify-between h-full font-mono text-xs">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between pb-2 border-b border-white/[0.08]">
                      <span className="text-sky-400 font-bold text-[11px] flex items-center gap-1.5 uppercase">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-2.5 rounded-lg bg-zinc-950 border border-white/[0.06] text-[11px] space-y-1">
                      <div className="flex justify-between text-zinc-400">
                        <span>Commit:</span>
                        <span className="text-sky-400">#a84f2e1</span>
                      </div>
                      <div className="flex justify-between text-zinc-400">
                        <span>Cluster:</span>
