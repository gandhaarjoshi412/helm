...
- Execution Sandbox: Ephemeral isolated container v1.4`,
    },
    {
      ...
      code: `[HELM Implementation Plan: Low Risk]
...
- Status: PRODUCTION HEALTHY (0 error rate recorded)`,
  ...
  return (
    <section id="agent" className="relative py-24 bg-[#090b0e] border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed">
            Every step is transparent, sandboxed, and verified. HELM replaces guesswork with a deterministic five-phase software lifecycle.
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-[#0c0e13] border border-white/[0.08] shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.08] bg-[#090b0e]">
            <div className="flex items-center gap-3 font-mono text-xs">
              ...
              <span className="font-bold text-sky-400 uppercase">{current.title} PHASE:</span>
