        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-semibold text-white tracking-tight text-base">Kodium Command Access</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg bg-zinc-950/80 border border-white/[0.1] text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition-all font-mono"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3.5 py-2.5 rounded-lg bg-zinc-950/80 border border-white/[0.1] text-sm text-white font-mono placeholder-zinc-500 focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition-all"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-lg bg-zinc-950/80 border border-white/[0.1] text-xs text-white focus:outline-none focus:border-white/50 font-mono"
                >
        ...
        {step === "connecting" && (
          <div className="py-8 flex flex-col items-center justify-center text-center space-y-4 font-mono">
            <div className="relative">
              ...
              <KodiumMark size={20} className="absolute inset-0 m-auto" />
            </div>
            <div>
          ...
          <div className="py-6 flex flex-col items-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 max-w-sm mt-1.5">
                We have queued <span className="text-zinc-200 font-mono font-bold">{email}</span> for priority onboarding to the Kodium Command Center preview for iQOO Hackathon 2026.
              </p>
            </div>
            ...
            <div className="w-full p-3 rounded-lg bg-zinc-950/90 border border-white/[0.08] text-xs font-mono text-zinc-300 flex items-center justify-between">
              ...
              <span className="text-zinc-200 font-bold">kodium_key_iqoo_9942a</span>
            </div>
