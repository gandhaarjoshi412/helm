...
export function FinalCta({ onOpenAccessModal }: FinalCtaProps) {
  ...
  return (
    <section className="relative py-32 bg-black border-t border-white/[0.08] overflow-hidden">
      {/* Background Command Center Matrix Pattern */}
      <div className="absolute inset-0 tech-grid opacity-30 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-white/[0.02] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 p-1.5 px-3 rounded-full bg-white/[0.04] border border-white/[0.08] text-xs font-mono text-zinc-300">
            <KodiumMark size={16} glow />
            <span>KODIUM COMMAND CENTER PROTOTYPE</span>
            <span className="text-zinc-600">|</span>
            <span className="text-zinc-200 font-bold">iQOO HACKATHON 2026</span>
          </div>
          ...
          <div className="max-w-md mx-auto pt-4">
            <form onSubmit={handleSubmit} className="flex items-center gap-2 p-1.5 rounded-xl bg-zinc-950/90 border border-white/[0.12] shadow-2xl focus-within:border-white/50 transition-colors">
